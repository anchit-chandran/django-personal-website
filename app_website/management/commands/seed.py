    ...
    for filename in os.listdir(directory):
        ...
        if os.path.isfile(filepath):
            ...
            with open(filepath, 'r') as file:
                ...
                published_on = datetime.strptime(date_string, "%Y-%m-%d")#.replace(hour=default_time.hour, minute=default_time.minute, second=default_time.second)
