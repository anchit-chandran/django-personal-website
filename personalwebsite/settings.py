...
EMAIL_HOST_USER = os.environ.get("EMAIL_HOST_USER", "123")
EMAIL_HOST_PASSWORD = os.environ.get("EMAIL_HOST_PASSWORD", "456")
EMAIL_PORT = 587
EMAIL_USE_TLS = True
...
# FOR DIGITAL OCEAN DEPLOYMENT, USE `DATABASE_URL` ENV VAR
